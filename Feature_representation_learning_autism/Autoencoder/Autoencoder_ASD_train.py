...
if layer == 'AE':
    model = AutoEncoder().to(device='cuda:1')  # AutoEncoder
...
torch.save(best_model.state_dict(), '/camin1/yrjang/Autism classification/Checkpoint_auto/model/log/_best_AE_epoch%d.pkl' % best_epoch)
