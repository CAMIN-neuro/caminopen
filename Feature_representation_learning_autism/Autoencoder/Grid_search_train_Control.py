...
for what in ['dropout','lr','layer','unit']:
    ...
    for grid in [1,2]:
        ...
        if layer == 'AE':
            model = AutoEncoder(layer=nlayer, unit_=unit, dropout=dropout).to(device='cuda:0') # AutoEncoder
        ...
        os.mkdir('/camin1/yrjang/Autism classification/Auto_revision/SDSU/grid_sdsu/control/model_d{}_u{}_layer{}_lr{}'.format(dropout,unit[0],nlayer, lr))

        path = '/camin1/yrjang/Autism classification/Auto_revision/SDSU/grid_sdsu/control/model_d{}_u{}_layer{}_lr{}'.format(dropout,unit[0],nlayer, lr)
        ...
        # save result
        file = open('/camin1/yrjang/Autism classification/Auto_revision/SDSU/model_d{}_u{}_layer{}_lr{}__c_train.txt'.format(dropout,unit[0],nlayer, lr),'w')
        ...
        file = open('/camin1/yrjang/Autism classification/Auto_revision/SDSU/model_d{}_u{}_layer{}_lr{}__c_val.txt'.format(dropout, unit[0], nlayer, lr), 'w')
